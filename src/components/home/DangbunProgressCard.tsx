...
const DangbunProgressCard: React.FC<Props> = ({
  ...
  return (
    <section className='w-[176px] rounded-[8.5px] bg-[#F6F6F6] p-2.5 flex flex-col gap-3'>
      <div className='w-full flex items-center justify-between'>
        <BlueChip title={dutyName} />
        <div className='h-[22px] px-3 py-1 rounded-[31px] leading-[22px] bg-[#E0EAFF] flex items-center'>
          <span className='text-[#4D83FD] px-1 py-[2px] rounded-[21px] text-[12px] font-semibold'>
            {p}%
          </span>
        </div>
      </div>
