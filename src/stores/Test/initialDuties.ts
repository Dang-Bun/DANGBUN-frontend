...
export const initialDuties: Duty[] = [
  {
    ...
    tasks: [
      ...
      { id: 4,  title: '소파 청소',      dueTime: '21:00', members: ['이민준','최유리'],                 isCamera: true,  isChecked: false, date: d3 },
    ],
  },
  {
    id: 102,
    ...
    tasks: [
      ...
      { id: 8,  title: '바닥 쓸기',      dueTime: '20:20', members: ['최유리'],                           isCamera: false, isChecked: false, date: d3 },
    ],
  },
  {
    id: 103,
    ...
    iconKey: 'BRUSH_PINK',
    tasks: [
      { id: 9,  title: '상품 박스 정리',  dueTime: '20:20', members: ['멤버 전체'],                      isCamera: false, isChecked: false, date: d3 },
