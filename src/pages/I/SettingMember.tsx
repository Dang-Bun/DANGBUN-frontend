      ...
      <div>
        ...
        <div className='bg-[#4ceba5] rounded-xl p-4 mb-6'>
          ...
          <div className='flex flex-col items-center'>
            <div className='relative w-[100px] h-[100px] flex items-center justify-center'>
              <div className='absolute inset-0 bg-[#17cf73] rounded-full z-0' />
              <img
                src={Member}
                alt='프로필 이미지'
                className='mb-2 w-[53px] h-[61px] z-10'
              />
            </div>
            <div className='text-[12px] text-[#39be7b] font-semibold bg-white px-3 py-1 rounded-full mb-2'>
              맴버
            </div>
            <button className='w-[287px] bg-[#39be7b] text-white rounded-[8px] mt-[16px] px-6 py-2 text-sm flex items-center justify-center gap-4'>
        ...
        <div className='flex flex-col gap-[12px] cursor-pointer'>
          ...
          <div
            ...
            onClick={() => navigate('/dangerzone/member')}
          >
            <div className='flex items-center gap-3'>
              <div className='relative w-[34px] h-[34px] flex items-center justify-center'>
                <div className='absolute inset-0 bg-[#D4E0FD] rounded-full z-0' />
