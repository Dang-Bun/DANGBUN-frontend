...
const CalendarDetail: React.FC = () => {
  ...
  return (
    <div>
            ...
            <div className="flex items-center justify-between">
              ...
              {hasMore && (
                <button
                  ...
                  className="ml-3 flex items-center justify-center w-[28px] h-[28px] rounded-full"
      ...
      <div className="w-full flex flex-col items-center justify-between px-5 py-4">
        ...
        {/* 달력 */}
        <div className="w-[353px] h-fit py-5 flex justify-center items-center mt-1 bg-stone-50 rounded-2xl shadow-[0px_0px_8px_0px_rgba(0,0,0,0.05)] mx-auto">
          <Calendar
            className="w-80"
            locale="ko-KR"
