...
import CleanUpCard from '../../components/cleanUp/CleanUpCard_Member';
  ...
  return (
    <div className='flex flex-col w-[393px] px-5 '>
      <div ref={headerRef} className='fixed w-[353px] bg-[#fff]'>
        <Header title='청소 관리' showBackButton={true} />
        <div className='flex flex-row justify-between mt-[52px] mb-3'>
          ...
          <button
            ...
            onClick={() => navigate('/undangbunmember', { state: { placeId } })}
          >
...
export default CleanUpList_Member;
